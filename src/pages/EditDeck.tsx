  ...
  return (
    <DashboardLayout title={`${deck?.title || "Edit Asset"}`}>
      <div className="flex-1 relative space-y-4 max-w-4xl mx-auto w-full md:px-6">
        {/* ═══════════════ HEADER SECTION ═══════════════ */}
        <div className="relative py-4 px-4 md:px-0 border-b border-[#222]">
          <div className="flex items-center gap-4 relative z-10">
            ...
            <div className="w-16 h-12 rounded-md bg-[#111] border border-[#222] flex items-center justify-center overflow-hidden shrink-0 group">
        ...
        <div className="px-4 md:px-0 pb-8">
          <div className="bg-[#111] border border-[#222] rounded-lg p-6 relative overflow-hidden">
