        ...
        <div className="space-y-16">
          ...
          <section>
            ...
            <div className="text-slate-400 leading-relaxed space-y-4">
              <p>
                By accessing or using Deckly ("Service"), you agree to be bound
                by these Terms of Service ("Terms"). If you do not agree to
                these Terms, you may not access or use the Service.
              </p>
              <p>
                Deckly provides a pitch deck management platform that allows
                founders and investors to upload, organize, share, and track
                engagement with pitch decks and data rooms.
              </p>
            </div>
          </section>
          ...
          <section>
            ...
            <div className="text-slate-400 leading-relaxed space-y-4">
              <p>
                ...
                your jurisdiction) to use this Service. By creating an account,
            ...
            <div className="space-y-6">
              <div>
                ...
                <p className="text-sm text-slate-400 leading-relaxed">
                  ...
                  third-party authentication providers (Google, GitHub). You
              ...
              <div>
                ...
                <p className="text-sm text-slate-400 leading-relaxed">
                  ...
                  page. We reserve the right to suspend or terminate accounts
          ...
          <section>
            ...
            <div className="text-slate-400 leading-relaxed space-y-4">
              ...
              <ul className="space-y-3 text-sm text-slate-400 list-disc list-inside">
                ...
                <li>
                  Use automated systems to scrape, copy, or replicate Service
                  content
                </li>
                <li>
                  Share confidential or proprietary information without proper
                  authorization
                </li>
                <li>
            ...
            <div className="space-y-6 text-slate-400 leading-relaxed">
              <div>
                ...
                <p className="text-sm leading-relaxed">
                  ...
                  Deckly (pitch decks, documents, metadata). By uploading
                  content, you grant Deckly a limited, non-exclusive license to
                  store, process, and display your content solely for the
              ...
              <div>
                ...
                <p className="text-sm leading-relaxed">
                  Deckly's software, design, branding, and proprietary features
          ...
          <section>
            ...
            <div className="text-slate-400 leading-relaxed space-y-4">
              <p>
                Deckly provides the following features subject to your
                subscription tier:
              </p>
              <ul className="space-y-3 text-sm text-slate-400 list-disc list-inside">
                <li>
                  <strong className="text-white">Document Management:</strong>{" "}
                  Upload, organize, version, and manage PDF pitch decks with
                  custom branding, metadata, and access controls
                </li>
                <li>
                  <strong className="text-white">Data Rooms:</strong> Organize
                  multiple documents into secure, shareable collections with
                  granular permissions
                </li>
                <li>
                  <strong className="text-white">AI Summarization:</strong>{" "}
                  Automatically generate concise, AI-powered summaries of
                  uploaded documents for quick review and analysis
                </li>
                <li>
                  <strong className="text-white">Reviews & Feedback:</strong>{" "}
                  Add private notes, tags, and structured reviews to documents
                  for internal collaboration
                </li>
                <li>
                  <strong className="text-white">Analytics:</strong> Track
                  viewer engagement, page views, time spent, and geographic
                  location data
                </li>
                <li>
                  <strong className="text-white">Sharing Controls:</strong> Set
                  expiration dates, disable downloads, require email
                  verification, and manage access links
                </li>
              </ul>
              <p>
                We reserve the right to modify, suspend, or discontinue any
                feature of the Service at any time. We will provide reasonable
                notice for material changes affecting paid tiers.
              </p>
            </div>
          </section>
          ...
          <section>
            ...
            <div className="text-slate-400 leading-relaxed space-y-4">
              ...
              <ul className="space-y-3 text-sm text-slate-400 list-disc list-inside">
                <li>
                  Payments are processed securely through a third-party payment
                  gateway
                </li>
                <li>
                ...
                <li>
                  Refunds are provided in accordance with applicable consumer
                  protection laws
                </li>
                <li>
                ...
                <li>
                  You may cancel at any time, but access will continue through
          ...
          <section>
            ...
            <div className="text-slate-400 leading-relaxed space-y-4">
              ...
              <p>
                <strong>No Investment Advice:</strong> Deckly does not provide
                investment, legal, or financial advice. Content shared through
                the Service is the responsibility of the uploading user.
              </p>
              <p>
                <strong>Third-Party Services:</strong> The Service may integrate
                with third-party providers (Supabase, Vercel, PostHog, Stripe).
                We are not responsible for the availability or performance of
          ...
          <section>
            ...
            <div className="text-slate-400 leading-relaxed space-y-4">
              <p>
                To the maximum extent permitted by law, Deckly and its operators
              ...
              <p>
                ...
                not exceed the amount you paid to Deckly in the 12 months
                preceding the claim.
              </p>
            </div>
          </section>
          ...
          <section>
            ...
            <div className="text-slate-400 leading-relaxed">
              <p>
                You agree to indemnify and hold harmless Deckly, its operators,
                and affiliates from any claims, damages, losses, or expenses
                (including legal fees) arising from your use of the Service,
                your uploaded content, or your violation of these Terms.
              </p>
            </div>
          </section>
          ...
          <section>
            ...
            <div className="text-slate-400 leading-relaxed space-y-4">
              <p>
                ...
                Service, legal requirements, or business practices. We will
                notify users of material changes via email or a prominent notice
                within the application at least 30 days before changes take
                effect.
              </p>
              <p>
          ...
          <section className="pt-20 border-t border-white/5 text-center">
            ...
            <p className="text-slate-500 text-sm max-w-lg mx-auto mb-8">
              For questions about these Terms, legal inquiries, or concerns
              about our practices, please contact our team.
            </p>
            <a
