      ...
      <div className="p-6 rounded-lg bg-[#1a0f0f] border border-red-900/50 flex flex-col md:flex-row items-center justify-between gap-6 relative overflow-hidden">
        ...
        <div className="flex flex-col sm:flex-row items-center gap-4 w-full md:w-auto mt-4 md:mt-0">
          <Button
            ...
            className="w-full sm:w-auto h-11 px-6 rounded-md font-semibold text-sm bg-red-500/10 hover:bg-red-500 text-red-500 hover:text-white border border-red-500/20 shadow-none transition-all"
          >
