...
export const RestartTourButton: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      <RotateCcw
        size={14}
        className="relative z-10 group-hover:rotate-[-45deg] transition-transform duration-300"
      />
      <span className="relative z-10 text-[9px] font-bold uppercase tracking-[0.2em]">
        Restart Tutorial
      </span>
    </motion.button>
  );
