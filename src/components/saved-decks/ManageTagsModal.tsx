...
export function ManageTagsModal({
  ...
  const handleEdit = (tag: LibraryTag) => {
    ...
    const validColor =
      TAG_COLORS.find((c) => c.value.toLowerCase() === tag.color.toLowerCase())
        ?.value || tag.color;
                ...
                <div className="flex items-start justify-between">
                  <div className="space-y-3">
                    ...
                    <p className="text-[#bbcbbb]/60 text-sm leading-relaxed font-medium">
                      Create and manage custom tags to categorize your folders
                      and documents.
                    </p>
                  </div>
                  <button
                ...
                <div className="bg-surface-card border border-white/5 p-6 space-y-6">
                  ...
                  <div className="flex gap-3 pt-2">
                    ...
                    <button
                      ...
                      className="flex-1 px-4 py-3 bg-[#54e98a] text-[#003919] font-bold text-xs tracking-wide flex items-center justify-center gap-2 hover:opacity-90 active:scale-[0.98] transition-all disabled:opacity-40 disabled:active:scale-100"
                    >
                      {isLoading ? (
